...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>quynoscam chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "quynoscam", HidePremium = false, IntroText = "quynoscam⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("quynoscam SCRIPT")
W:AddLabel("Discordquynoscam")
local Section = W:AddSection({
    Name = "Status"
})
